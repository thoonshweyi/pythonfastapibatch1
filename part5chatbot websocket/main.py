...
#                botresponse = completion.choices[0].message.content
#                # await websocket.send_text(str(botresponse)) # explain ho to get choices[0].message.content
...
# Streaming result
# ChatCompletionChunk(id='chatcmpl-BVIx1J9sp9RNFPNhrPrmt5VhcDBra', choices=[Choice(delta=ChoiceDelta(content=' web', function_call=None, refusal=None, role=None, tool_calls=None), finish_reason=None, index=0, logprobs=None)], created=1746800715, model='gpt-3.5-turbo-0125', object='chat.completion.chunk', service_tier='default', system_fingerprint=None, usage=None)

# Not streaming result 
# ChatCompletion(id='chatcmpl-BVIyHqQHRMj6K4WbO7BIrSsHmig3h', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content="Why did the web developer break up with their internet browser?\n\nBecause they couldn't handle their pop-ups anymore!", refusal=None, role='assistant', annotations=[], audio=None, function_call=None, tool_calls=None))], created=1746800793, model='gpt-3.5-turbo-0125', object='chat.completion', service_tier='default', system_fingerprint=None, usage=CompletionUsage(completion_tokens=23, prompt_tokens=25, total_tokens=48, completion_tokens_details=CompletionTokensDetails(accepted_prediction_tokens=0, audio_tokens=0, reasoning_tokens=0, rejected_prediction_tokens=0), prompt_tokens_details=PromptTokensDetails(audio_tokens=0, cached_tokens=0)))
